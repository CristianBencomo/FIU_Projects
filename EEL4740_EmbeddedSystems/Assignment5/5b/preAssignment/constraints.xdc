...
### LEDs
set_property PACKAGE_PIN U16 [get_ports {lock}]					
...
set_property PACKAGE_PIN W19 [get_ports blue]						
	set_property IOSTANDARD LVCMOS33 [get_ports blue]
set_property PACKAGE_PIN T17 [get_ports red]						
	set_property IOSTANDARD LVCMOS33 [get_ports red]
set_property PACKAGE_PIN U17 [get_ports green]						
	set_property IOSTANDARD LVCMOS33 [get_ports greenD]
...
###Pmod Header JC
#Sch name = JC1
#set_property PACKAGE_PIN K17 [get_ports {PButton}]					
